...
import { BookType, ImagePlus } from "lucide-react";
  ...
  return (
    <div className="mx-auto flex max-w-6xl flex-col px-1 md:px-6">
      ...
      <div className="relative mx-auto w-full max-w-4xl space-y-10">
        ...
        <div className="rounded-md border border-gray-300 px-4 py-6">
          <form id="blog-form" className="space-y-8">
            ...
            <div className="space-y-2">
              ...
              <TextEditor setContent={(c) => setContent(c)} />
            </div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex gap-2">
                  <Input
                    ...
                    className="border border-gray-300 w-2/5"
                    value={sourceName}
                  ...
                  />
                  <div>
                    <IoAddCircle size={32} onClick={addSource} />
                  </div>
                </div>
                <div className="flex gap-2 mt-2 flex-wrap">
                  {sources.map((src) => (
