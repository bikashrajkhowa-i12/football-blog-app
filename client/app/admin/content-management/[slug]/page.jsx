  ...
  useEffect(() => {
    async function fetchBlogDetails() {
      try {
        ...
        const { blog: matchedBlog = [] } = response?.data || {};
        setBlog(matchedBlog || null);
      } catch (error) {
        console.log(error?.message || "Failed to fetch the blog from db!");
      } finally {
        setLoading(false);
      }
    }
    ...
    fetchBlogDetails();
    fetchBlogs(); //TODO: Add seperate api for fetching related blogs
